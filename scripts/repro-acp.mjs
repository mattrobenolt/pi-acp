...
async function main() {
  ...
  const testPrompts = prompts.length ? prompts : ['say one word: alpha', 'say one word: beta', 'thank you sir']
  for (const prompt of testPrompts) {
    ...
    console.log(`PROMPT_RESULT ${JSON.stringify(response)} CHUNKS ${JSON.stringify(currentPromptChunks.join(''))}`)
  }
}
